...
const Header: React.FC<ISectionProps> = ({ lng }) => {
  ...
  return (
    <>
      <header className="header fixed left-0 top-0 z-[9999] flex w-full items-center border-b border-gray-400 bg-black/60 !bg-opacity-80 shadow-sticky backdrop-blur-sm transition">
          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex items-center justify-end">
                    ...
                    <li key={index} className="group relative">
                      {menuItem.path ? (
                        checkScrollUrl(menuItem.path) ? (
                          ...
                          <Link
                            href={menuItem.path}
                            className={`flex py-2 text-xs font-semibold text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${
              ...
              <div className="relative ml-16">
                <button
                  className="flex items-center gap-2 rounded-lg bg-gray-700 px-3 py-2 text-sm text-white hover:bg-gray-600 focus:ring-2 focus:ring-white/70"
                ...
                <ul
                  className={`absolute mt-2 w-full rounded-md bg-white shadow-lg ${
